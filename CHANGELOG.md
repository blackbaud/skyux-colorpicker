...
- Updated the colorpicker component to allow the text editor component to display an icon overlay on top of the picker button. [#108](https://github.com/blackbaud/skyux-colorpicker/pull/108)
