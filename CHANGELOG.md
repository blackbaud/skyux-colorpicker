...
- Fixed colorpicker component to stop firing the `valueChanges` event multiples times when a form group is updated. [blackbaud/skyux-colorpicker#5](https://github.com/blackbaud/skyux-colorpicker/pull/5)
